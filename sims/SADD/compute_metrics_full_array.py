...
filelist = np.sort(glob.glob('./uvfits_individual_bands_full/*86*.uvfits'))
...
filelist = np.sort(glob.glob('./uvfits_individual_bands_full/*230*.uvfits'))
...
filelist = np.sort(glob.glob('./uvfits_individual_bands_full/*345*.uvfits'))
