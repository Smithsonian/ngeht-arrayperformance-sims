...
The second part uses the "compute_metrics_full_array.py" script, which computes and prints out various metric values appropriate for "full array" operations of the array.
