...
print('Inverse shortest projected non-intrasite baseline: ' +
      str((1.0/np.mean(min_bl_86))/eh.RADPERUAS) + ' uas')
...
print('Inverse shortest projected non-intrasite baseline: ' +
      str((1.0/np.mean(min_bl_230))/eh.RADPERUAS) + ' uas')
...
print('Inverse shortest projected non-intrasite baseline: ' +
      str((1.0/np.mean(min_bl_345))/eh.RADPERUAS) + ' uas')
